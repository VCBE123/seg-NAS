...
import numpy as np
from nas import NASRayNetEval, WeightDiceLoss, ray2, ray3,NASRayNetEval_aspp_2,NASRayNetEval_aspp_base
...
def get_parser():
    ...
    parser.add_argument('--arch', default='nasray_ray2_ASPP_Cell_kernel')
