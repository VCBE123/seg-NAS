...
import numpy as np
from nas import NASRayNetEval_v0, NASRayNetEval_v0_dense, WeightDiceLoss, sk1, ray3, NASRayNetEvalDense, MultipleOptimizer
...
def get_parser():
    ...
    parser.add_argument('--gpus', default='6,5,7')
...
def main():
    ...
    model = NASRayNetEval_v0_dense(genotype=sk1)
    ...
    lr_scheduler_encoder = torch.optim.lr_scheduler.CosineAnnealingLR( optimizer_encoder, ARGS.epochs)
    lr_scheduler_decoder = torch.optim.lr_scheduler.CosineAnnealingLR( optimizer_decoder, ARGS.epochs)
